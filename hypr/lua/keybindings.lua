...
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_volume.sh up"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_volume.sh down"), { locked = true, repeating = true })
hl.bind("XF86AudioMute",        hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_volume.sh mute"), { locked = true })
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_brightness.sh up"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_brightness.sh down"), { locked = true, repeating = true })
